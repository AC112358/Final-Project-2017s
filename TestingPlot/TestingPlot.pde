...
import processing.core.PApplet;
  ...
  public void setup(){
    ...
    try {
      c = new Container(this, 500, 500, 50, 50, dataPath("someHIP_MEN.txt"), dataPath("someHIP_MEN.txt"), true);//"HIP_MEN_chr_pos_rs_pval.txt", "HIP_WOMEN_chr_pos_rs_pval.txt", 2, .3f, true, false);
